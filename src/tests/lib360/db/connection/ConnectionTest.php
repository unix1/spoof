...
class ConnectionTest extends \PHPUnit_Framework_TestCase
{
	...
	*/
	public function testConstruct_BadDSN()
	{
		...
		$this->assertInstanceOf('\spoof\lib360\db\connection\ConfigException', $e, "Failed to throw a \spoof\lib360\db\connection\ConfigException on invalid DSN during instantiation");
	}
	...
	*/
	public function testConstruct_BadDSNDriver()
	{
		...
		$this->assertInstanceOf('\spoof\lib360\db\object\NotFoundException', $e, "Failed to throw a \spoof\lib360\db\object\NotFoundException on invalid driver name in DSN during instantiation");
	}
	...
	*/
	public function testConstruct_SuccessCustomDriver()
	{
		...
		$this->assertInstanceOf('\spoof\tests\lib360\db\connection\CustomDriver', $c->driver, "Connection driver is not an instance of custom driver class specified");

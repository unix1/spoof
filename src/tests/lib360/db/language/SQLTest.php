...
class SQLTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetConditionGroupOperator_Invalid()
    {
        ...
        $this->assertInstanceOf(
            '\spoof\lib360\db\language\SQLException',
            $e,
    ...
    public function testGetConditionOperator_GreaterOrEqual()
    {
        ...
        $v = $this->l->getConditionOperator($this->d, $c);
        $this->assertEquals(
            SQL::CONDITION_GREATER_THAN_OR_EQUAL,
            $v,
    ...
    public function testGetConditionOperator_LessOrEqual()
    {
        ...
        $v = $this->l->getConditionOperator($this->d, $c);
        $this->assertEquals(
            SQL::CONDITION_LESS_THAN_OR_EQUAL,
            $v,
    ...
    public function testGetFieldFormatted()
    {
        ...
        $this->assertEquals(
            $fieldFormattedExpected,
            $fieldFormattedActual,
    ...
    public function testGetSelectFieldFormatted_WithAs()
    {
        ...
        $expected = $this->l->getFieldFormatted(
                $this->d,
                $field
            ) . ' ' . SQL::SELECT_AS . ' ' . $this->d->columnQuoteStart . $field_as . $this->d->columnQuoteEnd;
    ...
    public function testGetJoin_Invalid()
    {
        ...
        $this->assertInstanceOf(
            '\spoof\lib360\db\join\UnknownTypeException',
            $e,
    ...
    public function testGetUpdateFields()
    {
        ...
        $expected->addString(
            SQL::UPDATE_FIELD_SEPARATOR . ' ' . $this->l->getFieldFormatted(
                $this->d,
                $field2key
            ) . ' ' . SQL::EQUALS, false
        );
    ...
    public function testGetInsert()
    {
        ...
        $expected->addString(
            SQL::BIND_CHAR . $randKeys[0] . SQL::INSERT_FIELD_SEPARATOR . ' ' .

...
class Condition implements ICondition
{
	...
	*	@param \lib360\db\value\IValue $value1 the left side of the condition
	*	@param string $operator database condition operator
	*	@param \lib360\db\value\IValue $value2 the right side of the condition
	*/
	public function __construct(\lib360\db\value\IValue $value1, $operator, \lib360\db\value\IValue $value2)
	{
		if (($operator == self::OPERATOR_IN || $operator == self::OPERATOR_NOT_IN) && $value2->getType() != \lib360\db\value\Value::TYPE_ARRAY)
		{
			throw new \InvalidArgumentException("Invalid second operand. OPERATOR_IN expects \lib360\db\Value::TYPE_ARRAY (" . \lib360\db\value\Value::TYPE_ARRAY . "); " . $value2->getType() . " given.");
		}
		$this->value1 = $value1;

...
/**
*	Simple SQL condition group class.
*	This class is used to describe a simple SQL condition group that is used to merge 2 or more SQL conditions or SQL condition groups themselves by SQL operators.
*	@see DBCondition
*/
...
class ConditionGroup implements IConditionGroup
{
	...
	*/
	...
	/**
	*	Array of operators.
	*	Property used to store array of database operators associated with additional merged database conditions.
	*/
	public $operators;

...
*	The actual extending classes need to provide the view name, connection alias name, default fields, and table join configuration.
*/
...
abstract class View extends Table implements IView
{
	...
	*	Possible types are \lib360\db\join\IJoin, ITable, or string table name.
	*	@see \lib360\db\join\Join
	*	@see Table
	*/
	public $joins = array();

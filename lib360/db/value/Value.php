...
class Value implements IValue
{
	...
	*	Type must match the actual type of the value parameter. This object will not explicitly cast the type.
	*	@param $value mixed value of the object
	*	@param $type int type of the value
	*	@throw DBValueInvalidException when specified type and actual type do not match
	*	@throw DBValueTypeUnknownException when invalid type is supplied
	*/

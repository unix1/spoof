...
interface IJoin
{
	...
	*/
	public function __construct($table_base, $type, $table_join, \lib360\db\condition\ICondition $condition);
	...
	*	@param \lib360\db\condition\ICondition $condition database condition object
	*/
	public function addTable($type, $table_join, \lib360\db\condition\ICondition $condition);

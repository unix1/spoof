...
abstract class Connection implements IConnection
{
	...
	*	@todo extra logging when \lib360\db\object\Factory throws exception?
	*/
	public function __construct(IConfig $config)
	{
		...
		try
		{
			$this->driver = \lib360\db\object\Factory::get(\lib360\db\object\Factory::OBJECT_TYPE_DRIVER, $driverName);
		}

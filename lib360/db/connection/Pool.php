...
*	This static class provides connection pooling functionality for database connections.
*/
...
class Pool implements IPool
{
	...
	*	@param boolean $connect if TRUE and not yet connected the database connection will be attempted, default TRUE

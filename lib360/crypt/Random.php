...
class Random
{
	...
	/**
	*	Internal property to store values already generated; used to verify uniqueness of a new value
	*/
	...
	*	@param $unique boolean whether value should be unique
	*	@param $addToUniqueList boolean whether to add to unique list

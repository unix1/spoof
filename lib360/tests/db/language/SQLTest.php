...
class SQLTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->l = new \lib360\db\language\SQL();
		$this->d = new HelperDriver();
	}

	/**
	*	@covers \lib360\db\language\SQL::getConditionGroupOperator
	*/
	public function testGetConditionGroupOperator_And()
	{
		$v = $this->l->getConditionGroupOperator($this->d, \lib360\db\condition\ConditionGroup::OPERATOR_AND);
		$this->assertEquals(\lib360\db\language\SQL::CONDITIONGROUP_AND, $v, "Failed to return AND operator value");
	}
	...
	*/
	...
	{
		$v = $this->l->getConditionGroupOperator($this->d, \lib360\db\condition\ConditionGroup::OPERATOR_OR);
		$this->assertEquals(\lib360\db\language\SQL::CONDITIONGROUP_OR, $v, "Failed to return AND operator value");
	}
	...
	*/
	public function testGetConditionGroupOperator_Invalid()
	{
		...
		catch (\lib360\db\language\SQLException $e)
		{
		}
		$this->assertInstanceOf('\lib360\db\language\SQLException', $e, "Failed to throw exception when invalid condition group operator specified");
	}

	/**
	*	@covers \lib360\db\language\SQL::getConditionOperator
	*/
	public function testGetConditionOperator_Equals()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_EQUALS,
						new \lib360\db\value\Value(3.02, \lib360\db\value\Value::TYPE_FLOAT)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_EQUALS, $v, "Failed to return SQL 'equals' operator");
	}
	...
	*/
	public function testGetConditionOperator_EqualsNull()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_EQUALS,
						new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_EQUALS_NULL, $v, "Failed to return SQL 'is/equals null' operator");
	}
	...
	*/
	public function testGetConditionOperator_NotEquals()
	{
		...
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_NOT_EQUALS, $v, "Failed to return SQL 'not equals' operator");
	}
	...
	*/
	public function testGetConditionOperator_NotEqualsNull()
	{
		...
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_NOT_EQUALS_NULL, $v, "Failed to return SQL 'is not/not equals null' operator");
	}
	...
	*/
	public function testGetConditionOperator_Greater()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_GREATER_THAN,
						new \lib360\db\value\Value(5, \lib360\db\value\Value::TYPE_INTEGER)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_GREATER_THAN, $v, "Failed to return SQL 'greater than' operator");
	}
	...
	*/
	public function testGetConditionOperator_GreaterOrEqual()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_GREATER_THAN_OR_EQUAL,
						new \lib360\db\value\Value(5, \lib360\db\value\Value::TYPE_INTEGER)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_GREATER_THAN_OR_EQUAL, $v, "Failed to return SQL 'greater than or equals' operator");
	}
	...
	*/
	public function testGetConditionOperator_Less()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_LESS_THAN,
						new \lib360\db\value\Value(5, \lib360\db\value\Value::TYPE_INTEGER)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_LESS_THAN, $v, "Failed to return SQL 'less than' operator");
	}
	...
	*/
	public function testGetConditionOperator_LessOrEqual()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_LESS_THAN_OR_EQUAL,
						new \lib360\db\value\Value(5, \lib360\db\value\Value::TYPE_INTEGER)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_LESS_THAN_OR_EQUAL, $v, "Failed to return SQL 'less than or equals' operator");
	}
	...
	*/
	public function testGetConditionOperator_In()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_IN,
						new \lib360\db\value\Value(array(1, 2, 3), \lib360\db\value\Value::TYPE_ARRAY)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_IN, $v, "Failed to return SQL 'in' operator");
	}
	...
	*/
	public function testGetConditionOperator_NotIn()
	{
		$c = new \lib360\db\condition\Condition(
						new \lib360\db\value\Value('test', \lib360\db\value\Value::TYPE_COLUMN),
						\lib360\db\condition\Condition::OPERATOR_NOT_IN,
						new \lib360\db\value\Value(array(1, 2, 3), \lib360\db\value\Value::TYPE_ARRAY)
		);
		$v = $this->l->getConditionOperator($this->d, $c);
		$this->assertEquals(\lib360\db\language\SQL::CONDITION_NOT_IN, $v, "Failed to return SQL 'not in' operator");
	}
	...
	*/
	public function testGetConditionOperator_Invalid()
	{
		...
		$this->assertInstanceOf('\lib360\db\language\SQLException', $e, "Failed to throw an exception for invalid operator");
	}

	/**
	*	@covers \lib360\db\language\SQL::getFieldFormatted
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getValue
	*/
	public function testGetValue_Prepared()
	{
		$vString = 'prepared_value';
		$v = new \lib360\db\value\Value($vString, \lib360\db\value\Value::TYPE_PREPARED);
		$queryActual = $this->l->getValue($this->d, $v);
		$queryExpected = new \lib360\db\query\Query();
		$queryExpected->addString(\lib360\db\language\SQL::BIND_CHAR . $vString);
	...
	*/
	public function testGetValue_Column()
	{
		...
		$v = new \lib360\db\value\Value($vString, \lib360\db\value\Value::TYPE_COLUMN);
		$queryActual = $this->l->getValue($this->d, $v);
		$queryExpected = new \lib360\db\query\Query();
	...
	*/
	public function testGetValue_Null()
	{
		...
		$queryActual = $this->l->getValue($this->d, $v);
		$queryExpected = new \lib360\db\query\Query();
		$queryExpected->addString(\lib360\db\language\SQL::VALUE_NULL);
		$this->assertEquals($queryExpected, $queryActual, "Failed to return query object containing formatted column");
	}
	...
	*/
	...
	{
		$v1 = new \lib360\db\value\Value('test1', \lib360\db\value\Value::TYPE_PREPARED);
		$v2 = new \lib360\db\value\Value('test2', \lib360\db\value\Value::TYPE_PREPARED);
		$v3 = new \lib360\db\value\Value('table3.test3', \lib360\db\value\Value::TYPE_COLUMN);
		$v = new \lib360\db\value\Value(array($v1, $v2, $v3), \lib360\db\value\Value::TYPE_ARRAY);
		$queryActual = $this->l->getValue($this->d, $v);
		$queryExpected = new \lib360\db\query\Query();
		$expectedString = \lib360\db\language\SQL::CONDITION_VALUES_WRAPPER_START .
							' ' . \lib360\db\language\SQL::BIND_CHAR . $v1->getValue() .
							\lib360\db\language\SQL::CONDITION_VALUES_SEPARATOR .
							' ' . \lib360\db\language\SQL::BIND_CHAR . $v2->getValue() .
							\lib360\db\language\SQL::CONDITION_VALUES_SEPARATOR .
							' ' . $this->l->getFieldFormatted($this->d, $v3->getValue()) .
							' ' . \lib360\db\language\SQL::CONDITION_VALUES_WRAPPER_END;
	...
	*/
	...
	{
		$vString = 'test string';
		$v = new \lib360\db\value\Value($vString, \lib360\db\value\Value::TYPE_STRING);
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getCondition
	...
	*/
	...
	{
		$c = new \lib360\db\condition\Condition(
					new \lib360\db\value\Value('testcolumn1', \lib360\db\value\Value::TYPE_COLUMN),
					\lib360\db\condition\Condition::OPERATOR_EQUALS,
					new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL)
		);
	...
	*/
	public function testGetCondition_ConditionGroup()
	{
		...
		$o = \lib360\db\condition\ConditionGroup::OPERATOR_AND;
		$c2 = new \lib360\db\condition\Condition(
					new \lib360\db\value\Value('testcolumn1', \lib360\db\value\Value::TYPE_COLUMN),
					\lib360\db\condition\Condition::OPERATOR_EQUALS,
					new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL)
		);
		$c = new \lib360\db\condition\ConditionGroup($c1);
		$c->addCondition($o, $c2);
		$actual = $this->l->getCondition($this->d, $c);
		$expected = new \lib360\db\query\Query();
		$expected->setString(\lib360\db\language\SQL::CONDITION_WRAPPER_START);
		...
		$expected->addString(\lib360\db\language\SQL::CONDITION_WRAPPER_END);
		$this->assertEquals($expected, $actual, "Condition query object didn't match the expected value");
	}

	/**
	*	@covers \lib360\db\language\SQL::getSelectFieldFormatted
	*	@depends testGetFieldFormatted
	*/
	...
	*/
	public function testGetSelectFieldFormatted_WithAs()
	{
		...
		$expected = $this->l->getFieldFormatted($this->d, $field) . ' ' . \lib360\db\language\SQL::SELECT_AS . ' ' . $this->d->column_quote_start . $field_as . $this->d->column_quote_end;
		$this->assertEquals($expected, $actual, "Field didn't get formatted correctly for select as");
	}

	/**
	*	@covers \lib360\db\language\SQL::getSelectFields
	...
	*/
	public function testGetSelectFields()
	{
		...
		$expected = $this->l->getSelectFieldFormatted($this->d, $field1key, $field1value) .
					\lib360\db\language\SQL::SELECT_FIELD_SEPARATOR .
	...
	*/
	public function testGetSelectFields_AllArray()
	{
		$fields = array();
		$actual = $this->l->getSelectFields($this->d, $fields);
		$expected = \lib360\db\language\SQL::SELECT_FIELDS_ALL;
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getSelectFromTableName
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getSelectFromTable
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getJoin
	*	@depends testGetFieldFormatted
	*	@depends testGetValue_Column
	*/
	...
	{
		$table_base = 'comments';
		$join_type1 = \lib360\db\join\Join::JOIN_TYPE_LEFT_OUTER;
		$table_join1 = 'user';
		$cond1 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_base . '.user_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
							new \lib360\db\value\Value($table_join1 . '.id', \lib360\db\value\Value::TYPE_COLUMN)
					);
		$j = new \lib360\db\join\Join($table_base, $join_type1, $table_join1, $cond1);
		$actual = $this->l->getJoin($this->d, $j);
		$expected = new \lib360\db\query\Query();
		$expected->setString(
					$this->d->table_quote_start . $table_base . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::JOIN_TYPE_LEFT_OUTER . ' ' .
					$this->d->table_quote_start . $table_join1 . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::SELECT_JOIN_ON
		);
	...
	*/
	...
	{
		$table_base = 'comments';
		$join_type1 = \lib360\db\join\Join::JOIN_TYPE_INNER;
		$table_join1 = 'user';
		$cond1 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_base . '.user_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
		...
		$expected->setString(
					$this->d->table_quote_start . $table_base . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::JOIN_TYPE_INNER . ' ' .
					$this->d->table_quote_start . $table_join1 . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::SELECT_JOIN_ON
		);
		$expected->addQuery($this->l->getCondition($this->d, $cond1));
	...
	*/
	...
	{
		$table_base = 'comments';
		$join_type1 = \lib360\db\join\Join::JOIN_TYPE_JOIN;
		$table_join1 = 'user';
		$cond1 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_base . '.user_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
		...
		$expected->setString(
					$this->d->table_quote_start . $table_base . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::JOIN_TYPE_JOIN . ' ' .
					$this->d->table_quote_start . $table_join1 . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::SELECT_JOIN_ON
		);
		$expected->addQuery($this->l->getCondition($this->d, $cond1));
	...
	*/
	...
	{
		$table_base = 'comments';
		$join_type1 = \lib360\db\join\Join::JOIN_TYPE_RIGHT_OUTER;
		$table_join1 = 'user';
		$cond1 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_base . '.user_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
		...
		$expected->setString(
					$this->d->table_quote_start . $table_base . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::JOIN_TYPE_RIGHT_OUTER . ' ' .
					$this->d->table_quote_start . $table_join1 . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::SELECT_JOIN_ON
		);
		$expected->addQuery($this->l->getCondition($this->d, $cond1));
	...
	*/
	...
	{
		$table_base = 'comments';
		$join_type1 = \lib360\db\join\Join::JOIN_TYPE_FULL;
		$table_join1 = 'user';
		$cond1 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_base . '.user_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
		...
		$expected->setString(
					$this->d->table_quote_start . $table_base . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::JOIN_TYPE_FULL . ' ' .
					$this->d->table_quote_start . $table_join1 . $this->d->table_quote_end . ' ' .
					\lib360\db\language\SQL::SELECT_JOIN_ON
		);
		$expected->addQuery($this->l->getCondition($this->d, $cond1));
	...
	*/
	public function testGetJoin_Multiple()
	{
		...
		$join_type2 = \lib360\db\join\Join::JOIN_TYPE_INNER;
		$table_join2 = 'group';
		$cond2 = new \lib360\db\condition\Condition(
							new \lib360\db\value\Value($table_join1 . '.group_id', \lib360\db\value\Value::TYPE_COLUMN),
							\lib360\db\condition\Condition::OPERATOR_EQUALS,
							new \lib360\db\value\Value($table_join2 . '.id', \lib360\db\value\Value::TYPE_COLUMN)
					);
		$j = new \lib360\db\join\Join($table_base, $join_type1, $table_join1, $cond1);
	...
	*/
	public function testGetJoin_Invalid()
	{
		...
		catch (\lib360\db\join\UnknownTypeException $e)
		{
		}
		$this->assertInstanceOf('\lib360\db\join\UnknownTypeException', $e, "Failed to throw DBJoinTypeUnknownException for unknown or invalid join type");
	}

	/**
	*	@covers \lib360\db\language\SQL::getSelectFromView
	...
	*/
	public function testGetSelectFromView()
	{
		...
		$expected->addString(\lib360\db\language\SQL::SELECT_JOIN_SEPARATOR, FALSE);
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getSelectFrom
	*	@depends testGetSelectFromTable
	*/
	public function testGetSelectFrom_Table()
	{
		...
		$expected = new \lib360\db\query\Query($this->l->getSelectFromTable($this->d, $table));
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getSelect
	...
	*/
	public function testGetSelect_TableNoCondition()
	{
		...
		$expected = new \lib360\db\query\Query(\lib360\db\language\SQL::SELECT . ' ' . $this->l->getSelectFields($this->d) . ' ' . \lib360\db\language\SQL::FROM);
	...
	*/
	public function testGetSelect_TableCondition()
	{
		$t = new HelperTable();
		$c = new \lib360\db\condition\Condition(
				new \lib360\db\value\Value('testcolumn', \lib360\db\value\Value::TYPE_COLUMN),
				\lib360\db\condition\Condition::OPERATOR_EQUALS,
				new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL)
		);
		$actual = $this->l->getSelect($this->d, $t, $c);
		$fields = array();
		$expected = new \lib360\db\query\Query(\lib360\db\language\SQL::SELECT . ' ' . $this->l->getSelectFields($this->d, $fields) . ' ' . \lib360\db\language\SQL::FROM);
		$expected->addQuery($this->l->getSelectFrom($this->d, $t));
		$expected->addString(\lib360\db\language\SQL::WHERE);
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getUpdateFields
	*	@depends testGetValue_Column
	*	@depends testGetFieldFormatted
	*/
	public function testGetUpdateFields()
	{
		...
		$field1value = new \lib360\db\value\Value('testtable2.testfield1', \lib360\db\value\Value::TYPE_COLUMN);
		$field2key = 'testtable1.testfield2';
		$field2value = new \lib360\db\value\Value('testtable2.testfield2', \lib360\db\value\Value::TYPE_COLUMN);
		$fields = array($field1key => $field1value, $field2key => $field2value);
		$actual = $this->l->getUpdateFields($this->d, $fields);
		$expected = new \lib360\db\query\Query($this->l->getFieldFormatted($this->d, $field1key) . ' ' . \lib360\db\language\SQL::EQUALS);
		$expected->addQuery($this->l->getValue($this->d, $field1value));
		$expected->addString(\lib360\db\language\SQL::UPDATE_FIELD_SEPARATOR . ' ' . $this->l->getFieldFormatted($this->d, $field2key) . ' ' . \lib360\db\language\SQL::EQUALS, FALSE);
	...
	/**
	*	@covers \lib360\db\language\SQL::getUpdate
	*	@depends testGetSelectFrom_Table
	...
	*/
	public function testGetUpdate_TableNoCondition()
	{
		$t = new HelperTable();
		$field1key = 'field1';
		$field1value = new \lib360\db\value\Value('test1value', \lib360\db\value\Value::TYPE_STRING);
		$field2key = 'field2';
		$field2value = new \lib360\db\value\Value('test2value', \lib360\db\value\Value::TYPE_STRING);
		$fields = array(
		...
		$expected = new \lib360\db\query\Query(\lib360\db\language\SQL::UPDATE);
		$expected->addQuery($this->l->getSelectFrom($this->d, $t));
		$expected->addString(\lib360\db\language\SQL::UPDATE_SET);
		$expected->addString($this->l->getFieldFormatted($this->d, $field1key) . ' ' . \lib360\db\language\SQL::EQUALS);
		$expected->addString(\lib360\db\language\SQL::BIND_CHAR . $randKeys[0] . \lib360\db\language\SQL::UPDATE_FIELD_SEPARATOR);
		$expected->addString($this->l->getFieldFormatted($this->d, $field2key) . ' ' . \lib360\db\language\SQL::EQUALS);
		$expected->addString(\lib360\db\language\SQL::BIND_CHAR . $randKeys[1]);
	...
	*/
	public function testGetUpdate_TableCondition()
	{
		...
		$c = new \lib360\db\condition\Condition(
				new \lib360\db\value\Value('field3', \lib360\db\value\Value::TYPE_COLUMN),
				\lib360\db\condition\Condition::OPERATOR_EQUALS,
				new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL)
		);
	...
	/**
	*	@covers \lib360\db\language\SQL::getDelete
	*	@depends testGetSelectFrom_Table
	*/
	public function testGetDelete_TableNoCondition()
	{
		...
		$expected = new \lib360\db\query\Query(\lib360\db\language\SQL::DELETE . ' ' . \lib360\db\language\SQL::FROM);
		$expected->addQuery($this->l->getSelectFrom($this->d, $t));
	...
	*/
	...
	/**
	*	@covers \lib360\db\language\SQL::getInsertFields
	*	@depends testGetFieldFormatted
	*/
	public function testGetInsertFields()
	{
		$field1key = 'table1.field1';
		$field1value = new \lib360\db\value\Value('test1', \lib360\db\value\Value::TYPE_STRING);
		$field2key = 'field2';
		$field2value = new \lib360\db\value\Value('test2', \lib360\db\value\Value::TYPE_STRING);
		$field3key = 'field3';
		$field3value = new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL);
		...
		$expected = $this->l->getFieldFormatted($this->d, $field1key) . \lib360\db\language\SQL::INSERT_FIELD_SEPARATOR .
					$this->l->getFieldFormatted($this->d, $field2key) . \lib360\db\language\SQL::INSERT_FIELD_SEPARATOR .
	...
	/**
	*	@covers \lib360\db\language\SQL::getInsertValues
	*	@depends testGetValue_Null
	*/
	public function testGetInsertValues()
	{
		$field1key = 'table1.field1';
		$field1value = new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL);
		$field2key = 'field2';
		$field2value = new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL);
		$field3key = 'field3';
		$field3value = new \lib360\db\value\Value(NULL, \lib360\db\value\Value::TYPE_NULL);
		$fields = array($field1key => $field1value, $field2key => $field2value, $field3key => $field3value);
		...
		$expected = new \lib360\db\query\Query();
		$expected->addQuery($this->l->getValue($this->d, $field1value));
		$expected->addString(\lib360\db\language\SQL::INSERT_FIELD_SEPARATOR, FALSE);
		$expected->addQuery($this->l->getValue($this->d, $field2value));
		$expected->addString(\lib360\db\language\SQL::INSERT_FIELD_SEPARATOR, FALSE);
	...
	/**
	*	@covers \lib360\db\language\SQL::getInsert
	*	@depends testGetSelectFrom_Table
	...
	*/
	public function testGetInsert()
	{
		...
		$field2value = new \lib360\db\value\Value('test2', \lib360\db\value\Value::TYPE_STRING);
		$field3key = 'field3';
		$field3value = new \lib360\db\value\Value(3, \lib360\db\value\Value::TYPE_INTEGER);
		$fields = array($field1key => $field1value, $field2key => $field2value, $field3key => $field3value);
		$actual = $this->l->getInsert($this->d, $t, $fields);
		$randKeys = array_keys($actual->values);
		$expected = new \lib360\db\query\Query(\lib360\db\language\SQL::INSERT . ' ' . \lib360\db\language\SQL::INSERT_INTO);
		$expected->addQuery($this->l->getSelectFrom($this->d, $t));
		$expected->addString(\lib360\db\language\SQL::INSERT_VALUES_WRAPPER_START . ' ' .
								$this->l->getInsertFields($this->d, $fields) . ' ' .
								\lib360\db\language\SQL::INSERT_VALUES_WRAPPER_END . ' ' .
								\lib360\db\language\SQL::INSERT_VALUES . ' ' .
								\lib360\db\language\SQL::INSERT_VALUES_WRAPPER_START);
		$expected->addString(\lib360\db\language\SQL::BIND_CHAR . $randKeys[0] . \lib360\db\language\SQL::INSERT_FIELD_SEPARATOR . ' ' .
								\lib360\db\language\SQL::BIND_CHAR . $randKeys[1] . \lib360\db\language\SQL::INSERT_FIELD_SEPARATOR . ' ' .
								\lib360\db\language\SQL::BIND_CHAR . $randKeys[2]
		);
		$expected->addValues(array($randKeys[0] => $field1value, $randKeys[1] => $field2value, $randKeys[2] => $field3value));
		$expected->addString(\lib360\db\language\SQL::INSERT_VALUES_WRAPPER_END);

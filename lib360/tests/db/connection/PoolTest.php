...
class PoolTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->conn1 = new HelperConnection1(new \lib360\db\connection\Config('mysql:localhost'));
		$this->conn2 = new HelperConnection1(new \lib360\db\connection\Config('mysql:localhost'));
	}
	...
	/**
	*	@covers lib360\db\connection\Pool::add
	*/
	public function testAdd_SuccessNoException()
	{
		...
		try
		{
			\lib360\db\connection\Pool::add($this->conn1, 'test1');
		}
	...
	*/
	public function testAdd_SuccessElementKey()
	{
		...
		try
		{
			\lib360\db\connection\Pool::add($this->conn2, 'test2');
		}
		catch (\InvalidArgumentException $e)
		{
		}
		$this->assertArrayHasKey('test2', $this->getProtectedProperty('\lib360\db\connection\Pool', 'connections')->getValue(), "Failed to create an internal array key with given label");
	}
	...
	*/
	...
	{
		$c = $this->getProtectedProperty('\lib360\db\connection\Pool', 'connections')->getValue();
	...
	*/
	public function testAdd_FailDuplicate()
	{
		...
		try
		{
			\lib360\db\connection\Pool::add($this->conn2, 'test1');
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	/**
	*	@covers lib360\db\connection\Pool::getByName
	*	@depends testAdd_SuccessElementKey
	*/
	public function testGetByName_FailNotFound()
	{
		...
		try
		{
			\lib360\db\connection\Pool::getByName('test', FALSE);
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	*/
	public function testGetByName_SuccessNoException()
	{
		...
		try
		{
			\lib360\db\connection\Pool::getByName('test1', FALSE);
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	*/
	public function testGetByName_SuccessObject()
	{
		...
		try
		{
			$c = \lib360\db\connection\Pool::getByName('test1', FALSE);
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	*/
	public function testGetByName_SuccessWithConnect()
	{
		...
		try
		{
			$c = \lib360\db\connection\Pool::getByName('test1', TRUE);
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	/**
	*	@covers \lib360\db\connection\Pool::removeByName
	*	@depends testGetByName_SuccessNoConnection
	*/
	public function testRemoveByName_FailNotFound()
	{
		...
		try
		{
			\lib360\db\connection\Pool::removeByName('testconnection_that_doesnt_exist');
		}
		catch (\InvalidArgumentException $e)
		{
		}
	...
	*/
	public function testRemoveByName_SuccessNoDisconnectCheckConnection()
	{
		try
		{
			$c = \lib360\db\connection\Pool::getByName('test1');
			\lib360\db\connection\Pool::removeByName('test1', FALSE);
		}
		catch (\InvalidArgumentException $e)
		{
	...
	*/
	public function testRemoveByName_SuccessDisconnectCheckConnection()
	{
		try
		{
			$c = \lib360\db\connection\Pool::getByName('test2');
			\lib360\db\connection\Pool::removeByName('test2', TRUE);
		}
		catch (\InvalidArgumentException $e)
		{
			$this->fail("Got an exception when attempting to remove an existing connection from pool");
	...
	*/
	public function testCloseAll()
	{
		...
		try
		{
			$c1 = \lib360\db\connection\Pool::getByName('test1', FALSE);
			$c2 = \lib360\db\connection\Pool::getByName('test2', FALSE);
		}
		catch (\InvalidArgumentException $e)
		{
		}
